            ...
            >
              {CATEGORIES.map(cat => (
                <button
                  ...
                  className={`flex-shrink-0 px-6 md:px-8 py-3 md:py-3.5 rounded-full text-[9px] md:text-[10px] font-bold uppercase tracking-[0.15em] md:tracking-[0.2em] transition-all duration-500 border whitespace-nowrap ${selectedCategory === cat
