...
const Hero: React.FC = () => {
  ...
  return (
    <section id="inicio" className="relative min-h-[90vh] flex items-center overflow-hidden bg-[#FBCACA]">
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-16 z-10 relative">
        <div className="space-y-10">
          ...
          <div className="space-y-4">
            <h1 className="text-7xl lg:text-9xl font-serif leading-[0.9] text-[#1A1A1A]">
              Elegancia <br />
              <span className="italic font-normal text-[#C5A059] ml-4 md:ml-12">Total</span>
            </h1>
            <p className="text-[#1A1A1A]/70 text-lg md:text-xl max-w-md leading-relaxed font-light pl-1">
          ...
          <div className="flex flex-col items-start gap-5 pt-4">
            <a 
              ...
              className="btn-premium-gold w-full sm:w-auto text-center px-14 py-5 rounded-full font-bold uppercase text-[11px] tracking-[0.25em] active:scale-95"
            >
              Ver Trabajos
            </a>
            ...
            <a 
              ...
              className="group btn-outline-gold w-full sm:w-auto flex items-center justify-center gap-4 px-14 py-5 rounded-full text-[#1A1A1A] font-bold uppercase text-[11px] tracking-[0.25em] active:scale-95"
            >
              Servicios
              <div className="overflow-hidden h-4 w-4">
                <svg 
                  className="w-4 h-4 text-[#C5A059] transform transition-transform duration-500 group-hover:translate-y-full" 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
                >
                ...
                <svg 
                  className="w-4 h-4 text-[#C5A059] transform -translate-y-full transition-transform duration-500 group-hover:translate-y-[-100%]" 
                  fill="none" 
                  stroke="currentColor" 
                  viewBox="0 0 24 24"
