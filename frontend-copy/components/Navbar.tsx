...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? 'glass-nav py-3 shadow-sm' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        >
          ...
          <span className="text-[10px] uppercase tracking-[0.3em] text-[#1A1A1A] font-bold mt-1">byNaomi</span>
        </a>
        ...
        <button 
          ...
          className="btn-nav-minimal px-8 py-2.5 rounded-full text-[9px] font-bold uppercase tracking-[0.2em] active:scale-95 transition-all"
        >
          Reservar Cita
        </button>
      </div>
